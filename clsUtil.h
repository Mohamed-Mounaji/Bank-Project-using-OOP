...
public:
    ...
    enum enCharType {
        SmallLetter = 1, CapitalLetter,
        Digit, MixChars, SpecialChar
    };
    ...
    static void GenerateAndPrintKeys(short NumberOfKeys, enCharType CharType)
    {
    ...
    static vector <string>GenerateKeys(short NumberOfKeys, enCharType CharType)
    {
        vector <string> Keys;
        for (int i = 0; i < NumberOfKeys; i++)
        {
            Keys.push_back(GenerateKey(CharType));
        }
        return Keys;
    }
